...
-- Q22. Which driver, customer pair had the most orders
...
GROUP BY L.id, L.assembly1
ORDER BY total_fare DESC
LIMIT 1;


SELECT L.assembly1 AS location, SUM(CASE WHEN TD.customer_not_cancelled = 0 THEN 1 ELSE 0 END) AS total_cancellations
